...
export const AUDIT_ACTIONS = [
  ...
  "inspection.scheduled_from_portal",
...
const ACTION_LABELS: Record<string, string> = {
  ...
  "inspection.arrived_on_site": "Technician checked in on site",
  ...
  "inspection.scheduled_from_portal": "Customer requested inspection via portal",
  ...
  "repair_invoice.created": "Repair invoice created",
  "repair_invoice.sent": "Repair invoice sent",
  "repair_invoice.paid": "Repair invoice marked paid",
