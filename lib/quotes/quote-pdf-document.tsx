...
export function QuotePdfDocument({ data }: QuotePdfDocumentProps) {
  const quoteDate = formatReportDate(data.createdAt);
    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={styles.footer}>
          This quote covers repair work identified during the fire inspection listed above. Reply to
          your contact at {data.companyName} to approve work or ask questions.
        </Text>
      </Page>
    </Document>
  );
