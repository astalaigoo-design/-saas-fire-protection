      ...
      >
        ...
        <ul className="mt-10 grid gap-6 lg:grid-cols-3">
          ...
          <li className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              ...
              contractors who run real inspections and steer the roadmap. What you see was built
              from their trucks, ladders, and risers — not from guesses.
            </p>
          </li>
          <li className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            <h3 className="font-heading text-base font-semibold text-foreground">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              ...
              and the team building {APP_NAME} answers — questions, bug reports, and feature
              requests included.
            </p>
          </li>
        </ul>
        ...
        <div className="mt-8 rounded-2xl border border-primary/30 bg-card p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground sm:text-base">
            ...
            write to us and we&apos;ll answer personally. If you want to shape the product, ask
