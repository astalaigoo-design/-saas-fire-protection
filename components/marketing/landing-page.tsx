    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section id="pricing" className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-16">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-sm leading-6 text-muted-foreground sm:text-base">
            Full product access during the pilot — checkout is not live yet. We&apos;ll agree terms
            directly with the first contractors on the platform.
          </p>
        </div>

        <div className="mt-10 max-w-md rounded-2xl border border-primary/40 bg-card p-6 shadow-sm">
          ...
          <p className="mt-4 text-xs text-muted-foreground">Limited to 2–3 companies.</p>
        </div>
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl space-y-3">
              ...
              <p className="text-sm leading-6 text-muted-foreground sm:text-base">
                ...
                full field-to-report workflow on your phone. {TRIAL_DAYS}-day trial when paid billing
                launches — free during early access.
              </p>
            </div>
            <Link
              href="/sign-up"
