...
export type ChecklistCarouselHandle = {
...
export const ChecklistCarousel = forwardRef<ChecklistCarouselHandle, ChecklistCarouselProps>(
  function ChecklistCarousel(
    ...
    useImperativeHandle(ref, () => ({ scrollToItemId }), [scrollToItemId]);
